...
- **Multi-Resolution Monitoring** – Desktop and mobile monitoring (weekly, monthly, quarterly, yearly).  
...
Follow the steps below to install this SilverStripe module:

Open your project root directory
Make sure you are in the root folder of your SilverStripe project.

Require the module via Composer
Run the following command in your terminal:

composer require skynettechnologies/silverstripe-skynet-accessibility-scanner

Run a dev/build
After installation, rebuild the database and flush the cache:

vendor/bin/sake dev/build flush=1

Or open this URL in your browser:

https://yourdomain.com/dev/build?flush=1

Verify installation
Log in to your SilverStripe Admin and confirm that the module features are available.
