...
<link href="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\bootstrap.min.css')) ?>" rel="stylesheet">
<link href="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\scanning-and-monitoring-app.css')) ?>" rel="stylesheet">
                                                                    ...
                                                                    <div class="status-card">
                                                                        ...
                                                                        <?php if (($data['url_scan_status'] ?? 0) < 2): ?>
                                                                            <span class="status-value status-inactive">
                                                                                <img src="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\Image\not-shared.svg')) ?>"
                                                                                    alt=""
                                                                                    title="Not Started">
                                                                                Not Started
                                                                            </span>
                                                                    ...
                                                                    <div class="plan-info">
                                                                        <div class="plans-left">
                                                                            <span class="plan-type free">
                                                                                ...
                                                                                <img src="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\Image\round.svg')) ?>"
                                                                                        height="20" width="20">
                                                                                </div>
                                                                                <?php
                                                                                    ...
                                                                                    <div class="tier"
                                                                                        ...
                                                                                        <div class="pricing-top">
                                                                                            <div class="pricing-header">
                                                                                                <div class="icon-circle">
                                                                                                    <?php if ($index == 0): ?>
                                                                                                        <img src="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\Image\diamond.svg')) ?>" alt="" height="20" width="20">
                                                                                                    <?php elseif ($index == 1): ?>
                                                                                                        <img src="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\Image\pentagon.svg')) ?>" alt="" height="20" width="20">
                                                                                                    <?php elseif ($index == 2): ?>
                                                                                                        <img src="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\Image\hexagon.svg')) ?>" alt="" height="20" width="20">
                                                                                                    <?php elseif ($index == 3): ?>
                                                                                                        <img src="<?php echo (ModuleResourceLoader::resourceURL('vendor\skynettechnologies\silverstripe-skynet-accessibility-scanner\client\dist\css\Image\hexagon.svg')) ?>" alt="" height="20" width="20">
                                                                                                    <?php endif; ?>
                                                                                                </div>
